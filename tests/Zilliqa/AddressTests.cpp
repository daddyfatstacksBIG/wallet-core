...
TEST(ZilliqaAddress, Checksum) {
    ASSERT_EQ(checksumed(parse_hex("4BAF5FADA8E5DB92C3D3242618C5B47133AE003C")),
              "0x4BAF5faDA8e5Db92C3d3242618c5B47133AE003C");
    ASSERT_EQ(checksumed(parse_hex("448261915A80CDE9BDE7C7A791685200D3A0BF4E")),
              "0x448261915a80cdE9BDE7C7a791685200D3A0bf4E");
    ASSERT_EQ(checksumed(parse_hex("0xDED02FD979FC2E55C0243BD2F52DF022C40ADA1E")),
              "0xDed02fD979fC2e55c0243bd2F52df022c40ADa1E");
    ASSERT_EQ(checksumed(parse_hex("0x13F06E60297BEA6A3C402F6F64C416A6B31E586E")),
              "0x13F06E60297bea6A3c402F6f64c416A6b31e586e");
    ASSERT_EQ(checksumed(parse_hex("0x1A90C25307C3CC71958A83FA213A2362D859CF33")),
