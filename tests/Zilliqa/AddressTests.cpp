...
TEST(ZilliqaAddress, Checksum) {
    ASSERT_EQ(checksum(parse_hex("4BAF5FADA8E5DB92C3D3242618C5B47133AE003C")),
              "4BAF5faDA8e5Db92C3d3242618c5B47133AE003C");
    ASSERT_EQ(checksum(parse_hex("448261915A80CDE9BDE7C7A791685200D3A0BF4E")),
              "448261915a80cdE9BDE7C7a791685200D3A0bf4E");
    ASSERT_EQ(checksum(parse_hex("0xDED02FD979FC2E55C0243BD2F52DF022C40ADA1E")),
              "Ded02fD979fC2e55c0243bd2F52df022c40ADa1E");
    ASSERT_EQ(checksum(parse_hex("0x13F06E60297BEA6A3C402F6F64C416A6B31E586E")),
