...
TEST(ZilliqaSignature, Signing) {
    auto keyData = WRAPD(TWDataCreateWithHexString(
        STRING("0xafeefca74d9a325cf1d6b6911d61a65c32afa8e02bd5e78e2e4ac2910bab45f5").get()));
    ...
    auto signatureData =
        WRAPD(TWPrivateKeySignSchnorr(privateKey.get(), messageData.get(), TWCurveSECP256k1));
    ...
    EXPECT_EQ(hex(signature), "d166b1ae7892c5ef541461dc12a50214d0681b63d8037cda29a3fe6af8bb973e4ea9"
                              "4624d85bc0010bdc1b38d05198328fae21254adc2bf5feaf2804d54dba55");
}
