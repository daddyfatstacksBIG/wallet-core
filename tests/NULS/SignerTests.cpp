...
inline auto makeInput(std::string priKey, std::string addressFrom, std::string addressTo,
                      uint256_t amount, uint32_t chainId, uint32_t assetId, std::string nonce,
                      std::string remark, uint256_t balance) {
...
TEST(NULSSigner, Sign) {
    auto input =
        makeInput("9ce21dad67e0f0af2599b41b515a7f7018059418bab892a7b68f283d489abc4b",
