...
TEST(Bech32Address, Valid) {
    ...
    ASSERT_TRUE(Bech32Address::isValid(
        "cosmospub1addwnpepqftjsmkr7d7nx4tmhw4qqze8w39vjq364xt8etn45xqarlu3l2wu2n7pgrq", "cosmos"));
    ASSERT_TRUE(
        Bech32Address::isValid("cosmosvaloper1sxx9mszve0gaedz5ld7qdkjkfv8z992ax69k08", "cosmos"));
    ASSERT_TRUE(Bech32Address::isValid(
...
TEST(Bech32Address, Invalid) {
    ...
    ASSERT_FALSE(Bech32Address::isValid(
        "cosmospub1xddwnpepqftjsmkr7d7nx4tmhw4qqze8w39vjq364xt8etn45xqarlu3l2wu2n7pgrq", "cosmos"));
    ASSERT_FALSE(
        Bech32Address::isValid("cosmosvaloper1xxx9mszve0gaedz5ld7qdkjkfv8z992ax69k08", "cosmos"));
    ASSERT_FALSE(Bech32Address::isValid(
...
TEST(Bech32Address, FromString) {
    TestDecodeFromString("one1a50tun737ulcvwy0yvve0pvu5skq0kjargvhwe", "one",
                         "ed1ebe4fd1f73f86388f231997859ca42c07da5d");

    TestDecodeFromString("io187wzp08vnhjjpkydnr97qlh8kh0dpkkytfam8j", "io",
...
TEST(Bech32Address, FromKeyHash) {
    ...
    {
        const auto address =
            Bech32Address("one", parse_hex("0x587c66b4b973a7b231d02ebbc7e7d9f6c5a49ef2"));
        ASSERT_EQ("one1tp7xdd9ewwnmyvws96au0e7e7mz6f8hjqr3g3p", address.string());
    }
    {
        const auto address =
            Bech32Address("zil", parse_hex("0x91cdDcEBE846ce4d47712287EEe53cF17c2cfB77"));
        ASSERT_EQ("zil1j8xae6lggm8y63m3y2r7aefu797ze7mhzulnqg", address.string());
        const auto address2 =
            Bech32Address("zil", parse_hex("1d19918a737306218b5cbb3241fcdcbd998c3a72"));
...
TEST(Bech32Address, FromPublicKey) {
    {
        auto privateKey = PrivateKey(
            parse_hex("95949f757db1f57ca94a5dff23314accbe7abee89597bf6a3c7382c84d7eb832"));
        auto publicKey = privateKey.getPublicKey(TWPublicKeyTypeSECP256k1);
        ASSERT_EQ(hex(publicKey.bytes.begin(), publicKey.bytes.end()),
    ...
    {
        auto privateKey = PrivateKey(
            parse_hex("80e81ea269e66a0a05b11236df7919fb7fbeedba87452d667489d7403a02f005"));
        auto publicKey = privateKey.getPublicKey(TWPublicKeyTypeSECP256k1);
        ASSERT_EQ(hex(publicKey.bytes.begin(), publicKey.bytes.end()),
    ...
    {
        auto privateKey = PrivateKey(
            parse_hex("e2f88b4974ae763ca1c2db49218802c2e441293a09eaa9ab681779e05d1b7b94"));
    ...
    }
    {
        const auto privateKey = PrivateKey(
            parse_hex("3382266517e2ebe6df51faf4bfe612236ad46fb8bd59ac982a223b045e080ac6"));
        auto publicKey = privateKey.getPublicKey(TWPublicKeyTypeSECP256k1);
        ASSERT_EQ(hex(publicKey.bytes.begin(), publicKey.bytes.end()),
                  "02b65744e8bd0ba7666468abaff2aeb862c88a25ed605e0153100aa8f2661c1c3d");
...
TEST(Bech32Address, Hashes) {
    ...
    ASSERT_EQ("02b65744e8bd0ba7666468abaff2aeb862c88a25ed605e0153100aa8f2661c1c3d",
              hex(publicKey1.bytes.begin(), publicKey1.bytes.end()));
    ...
    ASSERT_EQ("04b65744e8bd0ba7666468abaff2aeb862c88a25ed605e0153100aa8f2661c1c3d83c307736082c09f1f"
              "22328e0fbeab40ddd198cf0f70fcdaa1e5969ca400c098",
...
TEST(Bech32Address, Prefixes) {
    ...
    auto publicKey = privateKey.getPublicKey(TWPublicKeyTypeSECP256k1);
    ASSERT_EQ("02b65744e8bd0ba7666468abaff2aeb862c88a25ed605e0153100aa8f2661c1c3d",
              hex(publicKey.bytes.begin(), publicKey.bytes.end()));
