...
TEST(IoTeXSigner, Sign) {
    ...
    auto h = signer.hash();
    ASSERT_EQ(hex(h.begin(), h.end()),
              "0f17cd7f43bdbeff73dfe8f5cb0c0045f2990884e5050841de887cf22ca35b50");
    auto sig = signer.sign();
    ASSERT_EQ(hex(sig.begin(), sig.end()),
              "555cc8af4181bf85c044c3201462eeeb95374f78aa48c67b87510ee63d5e502372e53082f03e9a11c1e3"
              "51de539cedf85d8dff87de9d003cb9f92243541541a000");
}
