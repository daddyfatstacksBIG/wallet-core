...
TEST(Signer, Sign) {
    ...
    ASSERT_EQ(hex(encoded.begin(), encoded.end()),
              "f86d01098504a817c800825208943535353535353535353535353535353535353535880de0b6b3a76400"
              "008025a0b3efa52659bb3dfcc1356942a5024ca55d742d8a2b551a142c5a0427c11c6272a07f616e8391"
              "04c8c9c8f83254afc4e5c7010293cd5e471f6756629d17c8392467");
    ASSERT_EQ(transaction.v, 37);
    ASSERT_EQ(
        transaction.r,
        uint256_t("81387416166961732074688826827458851755389597777750181844865627349674117325426"));
    ASSERT_EQ(
        transaction.s,
        uint256_t("57615878674481745412864351256912693004505281517367788339541976444424345429095"));
}
