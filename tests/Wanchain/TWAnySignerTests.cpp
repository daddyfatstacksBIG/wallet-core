...
TEST(TWAnySignerWanchain, Sign) {
    ...
    ASSERT_EQ(
        hex(output.r()),
        hex(store(uint256_t(
            "81387416166961732074688826827458851755389597777750181844865627349674117325426"))));
    ASSERT_EQ(
        hex(output.s()),
        hex(store(uint256_t(
            "57615878674481745412864351256912693004505281517367788339541976444424345429095"))));
}
