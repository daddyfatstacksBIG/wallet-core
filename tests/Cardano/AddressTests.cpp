...
TEST(CardanoAddress, Validation) {
    ...
    // valid V1 address
    ASSERT_TRUE(Address::isValid("DdzFFzCqrhssmYoG5Eca1bKZFdGS8d6iag1mU4wbLeYcSPVvBNF2wRG8yhjzQqErb"
                                 "g63N6KJA4DHqha113tjKDpGEwS5x1dT2KfLSbSJ"));
    ASSERT_TRUE(Address::isValid("DdzFFzCqrht7HGoJ87gznLktJGywK1LbAJT2sbd4txmgS7FcYLMQFhawb18ojS9Hx"
                                 "55mrbsHPr7PTraKh14TSQbGBPJHbDZ9QVh6Z6Di"));
...
TEST(CardanoAddress, FromString) {
    ...
    {
        auto address = Address("DdzFFzCqrhssmYoG5Eca1bKZFdGS8d6iag1mU4wbLeYcSPVvBNF2wRG8yhjzQqErbg6"
                               "3N6KJA4DHqha113tjKDpGEwS5x1dT2KfLSbSJ");
...
TEST(CardanoAddress, MnemonicToAddress) {
    {
        ...
        }
        {
            ...
            ASSERT_EQ("Ae2tdPwUPEZ6RUCnjGHFqi59k5WZLiv3HoCCNGCW8SYc5H9srdTzn1bec4W",
                      addr0.string());
        }
        {
            ...
            ASSERT_EQ("Ae2tdPwUPEZ7dnds6ZyhQdmgkrDFFPSDh8jG9RAhswcXt1bRauNw5jczjpV",
                      addr1.string());
        }
        {
            ...
            PublicKey pubKey1 = privKey1.getPublicKey(TWPublicKeyTypeED25519Extended);
            Address addr1 = Address(pubKey1);
            ASSERT_EQ("Ae2tdPwUPEZ8LAVy21zj4BF97iWxKCmPv12W6a18zLX3V7rZDFFVgqUBkKw",
                      addr1.string());
        }
    }
    {
    ...
    {
        // AdaLite Demo phrase, 12-word.  AdaLite uses V1 for it, in V2 it produces different
