...
TEST(NEARSigner, SignTx) {
    ...
    auto outputInBase64 =
        Base64::encode(Data(signed_transaction.begin(), signed_transaction.end()));

    ASSERT_EQ(outputInBase64,
              "CQAAAHRlc3QubmVhcgCRez0mjUtY9/"
              "7BsVC9aNab4+5dTMOYVeNBU4Rlu3eGDQEAAAAAAAAADQAAAHdoYXRldmVyLm5lYXIPpHP9JpAd8pa+"
              "atxMxN800EDvokNSJLaYaRDmMML+"
              "9gEAAAADAQAAAAAAAAAAAAAAAAAAAACWmoMzIYbul1Xkg5MlUlgG4Ymj0tK7S0dg6URD6X4cTyLe7vAFmo6X"
              "ExAO2m4ZFE2n6KDvflObIHCLodjQIb0B");
}
