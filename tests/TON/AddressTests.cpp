...
static string TestGiverUserRegular =
    "EQCBVndbeTJeXWLnQtm5bDC2UVpc0vH2TF2ksZPAPwcODdZT"; // regular base64
...
TEST(TONAddress, AddressValidRaw) {
    ...
    ASSERT_TRUE(
        Address::isValid("0:8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0d"));
    // no colon
    ASSERT_FALSE(
        Address::isValid("0 8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0d"));
    // invalid workchainID
    ASSERT_FALSE(
        Address::isValid("9:8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0d"));
    ASSERT_FALSE(
        Address::isValid("A:8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0d"));
    ASSERT_FALSE(
        Address::isValid(":8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0d"));
    // valid, but not supported chainID
    ASSERT_FALSE(
        Address::isValid("-1:8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0d"));
    // invalid address part
    ASSERT_FALSE(Address::isValid(
        "0:8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0dd")); // longer
    ASSERT_FALSE(Address::isValid(
        "0:8156775b79325e5d62e742d9b96c30b6515a5cd2f1f64c5da4b193c03f070e0")); // shorter
...
TEST(TONAddress, createStateInit) {
    const auto publicKey =
        PublicKey(parse_hex("F61CF0BC8E891AD7636E0CD35229D579323AA2DA827EB85D8071407464DC2FA3"),
    ...
    if (stateInit.cellCount() >= 2) {
        ...
        EXPECT_EQ("00000000f61cf0bc8e891ad7636e0cd35229d579323aa2da827eb85d8071407464dc2fa3",
                  hex(stateInit.getCells()[1]->getSlice().data()));
    }
...
TEST(TONAddress, AddressFromPublicKey) {
    ...
    EXPECT_EQ("0:240090ab66459bf6e61e3dfd43f7b9c1f1e7d4bd81d3b2a4ac7323cc1a970753",
              address.stringRaw());
    ...
    EXPECT_EQ("-1:240090ab66459bf6e61e3dfd43f7b9c1f1e7d4bd81d3b2a4ac7323cc1a970753",
              address.stringRaw());
