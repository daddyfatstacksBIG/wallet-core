...
TEST(TronSigner, SignTransferAsset) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "77f5eabde31e739d34a66914540f1756981dc7d782c9656f5e14e53b59a15371603a183aa12124adeee7"
              "991bf55acc8e488a6ca04fb393b1a8ac16610eeafdfc00");
}
...
TEST(TronSigner, SignTransfer) {
    ...
    const auto txTrieRoot =
        parse_hex("64288c2db0641316762a99dbb02ef7c90f968b60f9f2e410835980614332f86d");
    blockHeader.set_tx_trie_root(txTrieRoot.data(), txTrieRoot.size());
    const auto parentHash =
        parse_hex("00000000002f7b3af4f5f8b9e23a30c530f719f165b742e7358536b280eead2d");
    blockHeader.set_parent_hash(parentHash.data(), parentHash.size());
    ...
    ASSERT_EQ(hex(output.signature()),
              "ede769f6df28aefe6a846be169958c155e23e7e5c9621d2e8dce1719b4d952b63e8a8bf9f00e41204ac1"
              "bf69b1a663dacdf764367e48e4a5afcd6b055a747fb200");
}
...
TEST(TronSigner, SignFreezeBalance) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "aa7cf79fb1692ff432a1a3e520be3355c3e8168c5fa22f6e3b96c2a9f2e2827b49d67d5e6eea5c7e7cf8"
              "72047d422ce5d4d149c4df752b176d13f8f48920271201");
}
...
TEST(TronSigner, SignUnFreezeBalance) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "4b4b12b5fd091d5343335f14ac90bf23ea9a8167d648dd9d10d00c9c9b24731c484937bf133e5010f033"
              "8fb70a679a9a2eca8b945574005bc4015b419a68897300");
}
...
TEST(TronSigner, SignUnFreezeAsset) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "f493d8f275538a50bb8a832d759df9cad535bb2c5cc73296b04983f551d8398b6d7a30fc0fdfd73e8a9c"
              "ac77a1a6a9435dc6309bb98fbb219035e88809a0b65901");
}
...
TEST(TronSigner, SignWithdrawBalance) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "cb7d23a5eb23284a25ba6deaa231de0f18d8d103592e3312bff101a4219a3e02167eca24b3f4ce78b34f"
              "0c1842b6f7fb8d813f530c4c54342cdedef9f8e1f85100");
}
...
TEST(TronSigner, SignVoteAsset) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "501e04b08f359116a26d9ec784abc50830f92a9dc05d2c1aceefe0eba79466d2730b63b6739edf0f1f19"
              "72181618b201ce0b4167d14a66abf40eba4097c39ec400");
}
...
TEST(TronSigner, SignVoteWitness) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "79ec1073ae1319ef9303a2f5a515876cfd67f8f0e155bdbde1115d391c05358a3c32f148bfafacf07e16"
              "19aaed728d9ffbc2c7e4a5046003c7b74feb86fc68e400");
}
...
TEST(TronSigner, SignTriggerSmartContract) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "21a99aafeabdddfdfae86538df048d120a83eb36bbcf5656595919ba6afddacd0a07d0ba051ae8033761"
              "3174b109f36cb583b6e46ee5aecf6ffe3392fdbb8a2a01");
}
...
TEST(TronSigner, SignTransferTrc20Contract) {
    ...
    ASSERT_EQ(hex(output.signature()),
              "bec790877b3a008640781e3948b070740b1f6023c29ecb3f7b5835433c13fc5835e5cad3bd44360ff2dd"
              "ad5ed7dc9d7dee6878f90e86a40355b7697f5954b88c01");
}
} // namespace TW::Tron
