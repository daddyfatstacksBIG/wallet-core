...
TEST(TWEthereumAbi, FuncCreateEmpty) {
    TWEthereumAbiFunction* func =
        TWEthereumAbiEncoderBuildFunction(TWStringCreateWithUTF8Bytes("baz"));
...
TEST(TWEthereumAbi, EncodeFuncCase1) {
    TWEthereumAbiFunction* func =
        TWEthereumAbiEncoderBuildFunction(TWStringCreateWithUTF8Bytes("sam"));
    EXPECT_TRUE(func != nullptr);

    EXPECT_EQ(0,
              TWEthereumAbiFunctionAddParamBytes(
                  func, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("64617665")), false));
    ...
    EXPECT_EQ(0,
              TWEthereumAbiFunctionAddInArrayParamUInt256(
                  func, paramArrIdx, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("01"))));
    EXPECT_EQ(1,
              TWEthereumAbiFunctionAddInArrayParamUInt256(
                  func, paramArrIdx, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("02"))));
    EXPECT_EQ(2,
              TWEthereumAbiFunctionAddInArrayParamUInt256(
                  func, paramArrIdx, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("03"))));
...
TEST(TWEthereumAbi, EncodeFuncCase2) {
    TWEthereumAbiFunction* func =
        TWEthereumAbiEncoderBuildFunction(TWStringCreateWithUTF8Bytes("f"));
    EXPECT_TRUE(func != nullptr);

    EXPECT_EQ(0, TWEthereumAbiFunctionAddParamUInt256(
                     func, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("0123")), false));
    int paramArrIdx = TWEthereumAbiFunctionAddParamArray(func, false);
    ...
    EXPECT_EQ(2, TWEthereumAbiFunctionAddParamBytesFix(
                     func, 10,
                     TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("31323334353637383930")),
                     false));
    EXPECT_EQ(3, TWEthereumAbiFunctionAddParamString(
                     func, TWStringCreateWithUTF8Bytes("Hello, world!"), false));
...
TEST(TWEthereumAbi, EncodeFuncMonster) {
    ...
    TWEthereumAbiFunction* func =
        TWEthereumAbiEncoderBuildFunction(TWStringCreateWithUTF8Bytes("monster"));
    EXPECT_TRUE(func != nullptr);
    ...
    TWEthereumAbiFunctionAddParamUIntN(
        func, 168, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("0123")), false);
    ...
    TWEthereumAbiFunctionAddParamAddress(func,
                                         TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes(
                                             "f784682c82526e245f50975190ef0fff4e4fc077")),
                                         false);
    TWEthereumAbiFunctionAddParamBytes(
        func, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("31323334353")), false);
    TWEthereumAbiFunctionAddParamBytesFix(
        func, 5, TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("31323334353")), false);

    TWEthereumAbiFunctionAddInArrayParamUInt8(func, TWEthereumAbiFunctionAddParamArray(func, false),
                                              1);
    TWEthereumAbiFunctionAddInArrayParamUInt16(func,
                                               TWEthereumAbiFunctionAddParamArray(func, false), 2);
    TWEthereumAbiFunctionAddInArrayParamUInt32(func,
                                               TWEthereumAbiFunctionAddParamArray(func, false), 3);
    TWEthereumAbiFunctionAddInArrayParamUInt64(func,
                                               TWEthereumAbiFunctionAddParamArray(func, false), 4);
    TWEthereumAbiFunctionAddInArrayParamUIntN(
        func, TWEthereumAbiFunctionAddParamArray(func, false), 168,
        TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("0123")));
    TWEthereumAbiFunctionAddInArrayParamUInt256(
        func, TWEthereumAbiFunctionAddParamArray(func, false),
        TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("0123")));
    TWEthereumAbiFunctionAddInArrayParamInt8(func, TWEthereumAbiFunctionAddParamArray(func, false),
                                             1);
    TWEthereumAbiFunctionAddInArrayParamInt16(func, TWEthereumAbiFunctionAddParamArray(func, false),
                                              2);
    TWEthereumAbiFunctionAddInArrayParamInt32(func, TWEthereumAbiFunctionAddParamArray(func, false),
                                              3);
    TWEthereumAbiFunctionAddInArrayParamInt64(func, TWEthereumAbiFunctionAddParamArray(func, false),
                                              4);
    ...
    TWEthereumAbiFunctionAddInArrayParamInt256(
        func, TWEthereumAbiFunctionAddParamArray(func, false),
        TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("0123")));
    TWEthereumAbiFunctionAddInArrayParamBool(func, TWEthereumAbiFunctionAddParamArray(func, false),
                                             true);
    TWEthereumAbiFunctionAddInArrayParamString(func,
                                               TWEthereumAbiFunctionAddParamArray(func, false),
                                               TWStringCreateWithUTF8Bytes("Hello, world!"));
    ...
    TWEthereumAbiFunctionAddInArrayParamBytes(
        func, TWEthereumAbiFunctionAddParamArray(func, false),
        TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("31323334353")));
    TWEthereumAbiFunctionAddInArrayParamBytesFix(
        func, TWEthereumAbiFunctionAddParamArray(func, false), 5,
        TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes("31323334353")));
    ...
    EXPECT_EQ(std::string("Hello, world!"),
              std::string(TWStringUTF8Bytes(TWEthereumAbiFunctionGetParamString(func, 13, false))));
    TWEthereumAbiFunctionGetParamAddress(func, 14, false);

    TWString* type = TWEthereumAbiFunctionGetType(func);
    EXPECT_EQ("monster(uint8,uint16,uint32,uint64,uint168,uint256,int8,int16,int32,int64,int168,"
              "int256,bool,string,address,bytes,bytes5,"
              "uint8[],uint16[],uint32[],uint64[],uint168[],uint256[],int8[],int16[],int32[],int64["
              "],int168[],int256[],bool[],string[],address[],bytes[],bytes5[])",
...
TEST(TWEthereumAbi, DecodeOutputFuncCase1) {
    TWEthereumAbiFunction* func =
        TWEthereumAbiEncoderBuildFunction(TWStringCreateWithUTF8Bytes("readout"));
    EXPECT_TRUE(func != nullptr);
    ...
    // decode
    auto encoded = TWDataCreateWithHexString(TWStringCreateWithUTF8Bytes(
...
TEST(TWEthereumAbi, GetParamWrongType) {
    TWEthereumAbiFunction* func =
        TWEthereumAbiEncoderBuildFunction(TWStringCreateWithUTF8Bytes("func"));
    ...
    EXPECT_EQ(
        "00",
        hex(*(static_cast<const Data*>(TWEthereumAbiFunctionGetParamUInt256(func, 0, true)))));
    EXPECT_EQ(false, TWEthereumAbiFunctionGetParamBool(func, 0, true));
    EXPECT_EQ("",
              std::string(TWStringUTF8Bytes(TWEthereumAbiFunctionGetParamString(func, 0, true))));
    EXPECT_EQ(
        "", hex(*(static_cast<const Data*>(TWEthereumAbiFunctionGetParamAddress(func, 0, true)))));
    ...
    EXPECT_EQ(
        "00",
        hex(*(static_cast<const Data*>(TWEthereumAbiFunctionGetParamUInt256(func, 99, true)))));
    EXPECT_EQ(false, TWEthereumAbiFunctionGetParamBool(func, 99, true));
    EXPECT_EQ("",
              std::string(TWStringUTF8Bytes(TWEthereumAbiFunctionGetParamString(func, 99, true))));
    EXPECT_EQ(
        "", hex(*(static_cast<const Data*>(TWEthereumAbiFunctionGetParamAddress(func, 99, true)))));
