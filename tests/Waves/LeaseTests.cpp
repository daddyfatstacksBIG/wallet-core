...
TEST(WavesLease, serialize) {
    ...
    ASSERT_EQ(hex(serialized1),
              "080200425f57a8cb5439e4e912e66376f7041565d029ae4437dae1a3ebe15649d4346101574"
...
TEST(WavesLease, jsonSerialize) {
    ...
    ASSERT_EQ(json["proofs"].dump(), "[\"4opce9e99827upK3m3D3NicnvBqbMLtAJ4Jc8ksTLiScqBgjdqzr9JyXG"
    ...
    ASSERT_EQ(json.dump(), "{\"amount\":100000,\"fee\":100000,\"proofs\":["
...
TEST(WavesLease, jsonCancelSerialize) {
    ...
    ASSERT_EQ(json["timestamp"], int64_t(1568973547102));
    ASSERT_EQ(json["proofs"].dump(), "[\"Mwhh7kdbhPv9vtnPh6pjEcHTFJ5h5JtAziwFpqH8Ykw1yWYie4Nquh"
                                     "eYtAWPbRowgpDVBxvG1rTrv82LnFdByQY\"]");
    ASSERT_EQ(json.dump(),
              "{\"chainId\":87,\"fee\":100000,\"leaseId\":"
