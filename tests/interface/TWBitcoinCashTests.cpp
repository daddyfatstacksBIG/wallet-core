...
TEST(BitcoinCash, Address) {
    EXPECT_TRUE(TWAnyAddressIsValidString(
        STRING("pqx578nanz2h2estzmkr53zqdg6qt8xyqvwhn6qeyc").get(), TWCoinTypeBitcoinCash));
}

TEST(BitcoinCash, ValidAddress) {
    auto string = STRING("bitcoincash:qqa2qx0d8tegw32xk8u75ws055en4x3h2u0e6k46y4");
    auto address =
        WRAP(TWAnyAddress, TWAnyAddressCreateWithString(string.get(), TWCoinTypeBitcoinCash));
    ASSERT_NE(address.get(), nullptr);

    auto script =
        WRAP(TWBitcoinScript, TWBitcoinScriptBuildForAddress(string.get(), TWCoinTypeBitcoinCash));
...
TEST(BitcoinCash, LegacyToCashAddr) {
    auto privateKey =
        WRAP(TWPrivateKey,
             TWPrivateKeyCreateWithData(
                 DATA("28071bf4e2b0340db41b807ed8a5514139e5d6427ff9d58dbd22b7ed187103a4").get()));
    ...
    auto cashAddress =
        WRAP(TWAnyAddress, TWAnyAddressCreateWithPublicKey(publicKey, TWCoinTypeBitcoinCash));
...
TEST(BitcoinCash, LockScript) {
    auto address = WRAP(TWAnyAddress,
                        TWAnyAddressCreateWithString(
                            STRING("bitcoincash:qpk05r5kcd8uuzwqunn8rlx5xvuvzjqju5rch3tc0u").get(),
    ...
    auto script2 = WRAP(
        TWBitcoinScript,
        TWBitcoinScriptBuildForAddress(STRING("pzukqjmcyzrkh3gsqzdcy3e3d39cqxhl3g0f405k5l").get(),
                                       TWCoinTypeBitcoinCash));
...
TEST(BitcoinCash, ExtendedKeys) {
    ...
    auto xprv = WRAPS(TWHDWalletGetExtendedPrivateKey(wallet.get(), TWPurposeBIP44,
                                                      TWCoinTypeBitcoinCash, TWHDVersionXPRV));
    auto xpub = WRAPS(TWHDWalletGetExtendedPublicKey(wallet.get(), TWPurposeBIP44,
                                                     TWCoinTypeBitcoinCash, TWHDVersionXPUB));

    assertStringsEqual(xprv, "xprv9yEvwSfPanK5gLYVnYvNyF2CEWJx1RsktQtKDeT6jnCnqASBiPCvFYHFSApXv39bZ"
                             "bF6hRaha1kWQBVhN1xjo7NHuhAn5uUfzy79TBuGiHh");
    assertStringsEqual(xpub, "xpub6CEHLxCHR9sNtpcxtaTPLNxvnY9SQtbcFdov22riJ7jmhxmLFvXAoLbjHSzwXwNNu"
                             "xC1jUP6tsHzFV9rhW9YKELfmR9pJaKFaM8C3zMPgjw");
}

TEST(BitcoinCash, DeriveFromXPub) {
    auto xpub = STRING("xpub6CEHLxCHR9sNtpcxtaTPLNxvnY9SQtbcFdov22riJ7jmhxmLFvXAoLbjHSzwXwNNuxC1jUP"
                       "6tsHzFV9rhW9YKELfmR9pJaKFaM8C3zMPgjw");
    auto pubKey2 =
    ...
    auto address2 =
        WRAP(TWAnyAddress, TWAnyAddressCreateWithPublicKey(pubKey2, TWCoinTypeBitcoinCash));
    auto address2String = WRAPS(TWAnyAddressDescription(address2.get()));

    auto address9 =
        WRAP(TWAnyAddress, TWAnyAddressCreateWithPublicKey(pubKey9, TWCoinTypeBitcoinCash));
...
TEST(BitcoinCash, SignTransaction) {
    ...
    ASSERT_EQ(hex(serialized),
              ...
              "02000000"
              "6b483045022100b70d158b43cbcded60e6977e93f9a84966bc0cec6f2dfd1463d1223a90563f0d022075"
              "48d081069de570a494d0967ba388ff02641d91cadb060587ead95a98d4e3534121038eab72ec78e639d0"
              "2758e7860cdec018b49498c307791f785aa3019622f4ea5b"
              "ffffffff"
              "02"
              "5802000000000000"
