...
TEST(Nano, DeriveAddress) {
    ...
    auto words =
        STRING("edge defense waste choose enrich upon flee junk siren film clown finish luggage "
    ...
    ASSERT_EQ(TW::hex(key->impl.bytes),
              "3be4fc2ef3f3b7374e6fc4fb6e7bb153f8a2998b3b3dab50853eabe128024143");
    ASSERT_EQ(TW::hex(publicKey->impl.bytes),
