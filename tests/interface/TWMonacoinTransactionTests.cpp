...
TEST(MonacoinTransaction, SignTransaction) {
    /*
        ...
        m/44'/22'/0'/0/0 Private key in Base58 encoding -
       T8XV834egE6ZsgsQFPnBcYbNdFKNiGKiNj21mRjGx2scGNQh3ypZ m/44'/22'/0'/0/0 Private key in bytes -
       a356a193a24c73c657e0c7bbf4e876964984a2dcba986ea1ea1fca7b025218f3 utxo -
       https://blockbook.electrum-mona.org/tx/ed0a42ced5e5fc78a0568b4bdeb512dcfc47c1aace429cc060b6c3cc3d511a44
        tx -
       https://blockbook.electrum-mona.org/tx/0c2916dee64b1e60414199debfa22300c7ecd1f94f3a5602d2e5b9e120b63573
    */
    ...
    auto signer = Bitcoin::TransactionSigner<Bitcoin::Transaction, TransactionBuilder>(
        std::move(input), plan);
    ...
    ASSERT_EQ(hex(serialized),
              "0100000001441a513dccc3b660c09c42ceaac147fcdc12b5de4b8b56a078fce5d5ce420aed000000006a"
              "473044022047789dc7483b178199439bbfce0ab0caf532fec51095ba099d0d9b0b2169033402201745a0"
              "160d8d327655a8ef0542367396ce86bbb13df6b183d58c922e422cfa10012102fc08693599fda7415586"
              "13cd44a50fc65953b1be797637f8790a495b85554f3effffffff0280f0fa02000000001976a914076df9"
              "84229a2731cbf465ec8fbd35b8da94380f88ac60a2fa02000000001976a914fea39370769d4fed2d8ab9"
              "8dd5daa482cc56113b88ac00000000");
}
...
TEST(MonacoinTransaction, LockScripts) {
    ...
    auto script = WRAP(TWBitcoinScript,
                       TWBitcoinScriptBuildForAddress(
                           STRING("M8aShwteMWyAbUw4SGS4EHLqfo1EfnKHcM").get(), TWCoinTypeMonacoin));
    ...
    auto script2 =
        WRAP(TWBitcoinScript,
             TWBitcoinScriptBuildForAddress(STRING("P91UYtoBS4XAD39fEzaeMaq7YmMa42FFNd").get(),
                                            TWCoinTypeMonacoin));
    ...
    auto script3 =
        WRAP(TWBitcoinScript,
             TWBitcoinScriptBuildForAddress(
                 STRING("mona1qytnqzjknvv03jwfgrsmzt0ycmwqgl0asju3qmd").get(), TWCoinTypeMonacoin));
