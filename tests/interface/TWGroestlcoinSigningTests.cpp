...
TEST(GroestlcoinSigning, SignP2WPKH) {
    ...
    auto result =
        TransactionSigner<Groestlcoin::Transaction, TransactionBuilder>(std::move(input)).sign();
    ...
    ASSERT_EQ(hex(serialized),
              "010000000001019568b09e6c6d940302ec555a877c9e5f799de8ee473e18d3a19ae14478cc4e8f010000"
              "0000ffffffff02c40900000000000017a9140055b0c94df477ee6b9f75185dfc9aa8ce2e52e487000800"
              "00000000001976a91498af0aaca388a7e1024f505c033626d908e3b54a88ac024830450221009bbd0228"
              "dcb7343828633ded99d216555d587b74db40c4a46f560187eca222dd022032364cf6dbf9c0213076beb6"
              "b4a20935d4e9c827a551c3f6f8cbb22d8b464467012102e9c9b9b76e982ad8fa9a7f48470eafbeeba9bf"
              "6d287579318c517db5157d936e00000000");
}
...
TEST(GroestlcoinSigning, SignP2PKH) {
    ...
    ASSERT_EQ(
        hex(serialized),
        "01000000019568b09e6c6d940302ec555a877c9e5f799de8ee473e18d3a19ae14478cc4e8f000000006a473044"
        "02202163ab98b028aa13563f0de00b785d6df81df5eac0b7c91d23f5be7ea674aa3702202bf6cd7055c6f8f697"
        "ce045b1a4f9b997cf6e5761a661d27696ac34064479d19012103b85cc59b67c35851eb5060cfc3a759a4822545"
        "53c5857075c9e247d74d412c91ffffffff02c4090000000000001600147557920fbc32a1ef4ef26bae5e8ce3f9"
        "5abf09cee20800000000000017a9140055b0c94df477ee6b9f75185dfc9aa8ce2e52e48700000000");
}
...
TEST(GroestlcoinSigning, SignP2SH_P2WPKH) {
    ...
    EXPECT_EQ(hex(utxoPubkeyHash.begin(), utxoPubkeyHash.end()),
              "2fc7d70acef142d1f7b5ef2f20b1a9b759797674");
    ...
    ASSERT_EQ(hex(scriptHash.begin(), scriptHash.end()),
              "0055b0c94df477ee6b9f75185dfc9aa8ce2e52e4");
    ...
    auto hash0 = DATA(
        "fdae0772d7d1d33804a6b1ca0e391668b116bb7a70028427d3d82232189ce863"); // UTXO hash backwards
    utxo0->mutable_out_point()->set_hash(TWDataBytes(hash0.get()), TWDataSize(hash0.get()));
    utxo0->mutable_out_point()->set_index(0);
    utxo0->mutable_out_point()->set_sequence(UINT32_MAX);

    auto result =
        Bitcoin::TransactionSigner<Groestlcoin::Transaction, TransactionBuilder>(std::move(input))
            .sign();
    ASSERT_TRUE(result) << result.error();
    auto signedTx = result.payload();
    ...
    signedTx.encode(true, serialized);
    ASSERT_EQ(hex(serialized),
              "01000000000101fdae0772d7d1d33804a6b1ca0e391668b116bb7a70028427d3d82232189ce863000000"
              "00171600142fc7d70acef142d1f7b5ef2f20b1a9b759797674ffffffff0288130000000000001976a914"
              "98af0aaca388a7e1024f505c033626d908e3b54a88aca6120000000000001600147557920fbc32a1ef4e"
              "f26bae5e8ce3f95abf09ce024730440220614df57babf74029afaa6dda202afa47d3555cca7a0f20a22e"
              "466aeb7029e7d002207974b4c16f346811aff6720d09b9c58d0c4e01e8d258c3d203cc3c1ad228c61a01"
              "2102fb6ad115761ea928f1367befb2bee79c0b3497314b45e0b734cd150f0601706c00000000");
}
