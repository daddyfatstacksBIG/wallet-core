...
TEST(Zilliqa, Address) {
    ...
    EXPECT_FALSE(TWAnyAddressIsValidString(
        STRING("0x7FCcaCf066a5F26Ee3AFfc2ED1FA9810Deaa632C").get(), TWCoinTypeZilliqa));
    EXPECT_FALSE(TWAnyAddressIsValidString(
        STRING("bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4").get(), TWCoinTypeZilliqa));
    EXPECT_FALSE(
        TWAnyAddressCreateWithString(STRING("bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4").get(),
                                     TWCoinTypeZilliqa) != NULL);
    ...
    auto keyHashString =
        WRAPS(TWStringCreateWithRawBytes(TWDataBytes(keyHash.get()), strnlen(expectedKeyHash, 40)));
...
TEST(Zilliqa, Signing) {
    ...
    auto expected =
        TW::parse_hex("d166b1ae7892c5ef541461dc12a50214d0681b63d8037cda29a3fe6af8bb973e4ea94624d85b"
                      "c0010bdc1b38d05198328fae21254adc2bf5feaf2804d54dba55");
