...
TEST(TWCardano, Address) {
    auto privateKey = WRAP(
        TWPrivateKey, TWPrivateKeyCreateWithData(
                          DATA("b0884d248cb301edd1b34cf626ba6d880bb3ae8fd91b4696446999dc4f0b5744309"
                               "941d56938e943980d11643c535e046653ca6f498c014b88f2ad9fd6e71effbf36a8"
                               "fa9f5e11eb7a852c41e185e3969d518e66e6893c81d3fc7227009952d4")
                              .get()));
...
TEST(TWCardano, PlanAndSign) {
    ...
    Data privateKey = parse_hex("b8c31abcc41d931ae881be11da9e4d9242b1f01cae4e69fa29d5ba1f89f9c1549e"
                                "c844c6b39c70fa6d3a254fe57c1efee1a75eb9755e0b751e96dd288deabc881ae6"
                                "0957699bf72b212ca823520cf7d86af5d1304cd90248fe60bd1fe442870f");
...
TEST(TWCardano, PlanMaxAmount) {
    ...
    auto output = Proto::SigningOutput();
    ASSERT_TRUE(output.ParseFromArray(TWDataBytes(outputData), TWDataSize(outputData)));
    EXPECT_EQ("7b8f15787fa8e0f1cb8b459780e10102e8f883cb25d3a50e02a73818b3bac91f",
              output.transaction_id());
    EXPECT_EQ("", output.error());
}
