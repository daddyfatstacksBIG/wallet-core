...
TEST(NebulasTransaction, serialize) {
    ...
    ASSERT_EQ(TW::Base64::encode(transaction.raw),
              "CiBQXdR2neMqnEu21q/U+OHqZHSBX9Q0hNiRfL2eCZO4hRIaGVefwtw23wEobqA40/"
              "7aIwQHghETxH4r+50aGhlXf89CeLWgHFjKu9/"
              "6tn4KNbelsMDAIIi2IhAAAAAAAAAAAJin2bgxTAAAKAcwyony5wU6CAoGYmluYXJ5QAFKEAAAAAAAAAAAAAA"
              "AAAAPQkBSEAAAAAAAAAAAAAAAAAADDUBYAWJB9T9KkUH/"
...
TEST(NebulasTransaction, binaryPayload) {
    ...
    signer.sign(privateKey, transaction);
    ASSERT_EQ(
        TW::Base64::encode(transaction.raw),
        "CiB1Oqj7bxLQMHEoNyg/vFHmsTrGdkpTf/5qFDkYPB3bkxIaGVefwtw23wEobqA40/"
        "7aIwQHghETxH4r+50aGhlXf89CeLWgHFjKu9/"
        "6tn4KNbelsMDAIIi2IhAAAAAAAAAAAJin2bgxTAAAKAcwyony5wU6PQoGYmluYXJ5EjN7IkRhdGEiOnsiZGF0YSI6W"
        "zExNiwxMDEsMTE1LDExNl0sInR5cGUiOiJCdWZmZXIifX1AAUoQAAAAAAAAAAAAAAAAAA9CQFIQAAAAAAAAAAAAAAA"
        "AAAMNQFgBYkGHXq+JWPaEyeB19bqL3QB5jyM961WLq7PMTpnGM4iLtBjCkngjS81kgPM2TE4qKDcpzqjum/"
        "NccrZtUPQLGk0MAQ==");
}
