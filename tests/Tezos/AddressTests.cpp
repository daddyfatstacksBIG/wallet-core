...
TEST(TezosAddress, isValid) {
    std::array<std::string, 3> validAddresses{"tz1Yju7jmmsaUiG9qQLoYv35v5pHgnWoLWbt",
...
TEST(TezosAddress, PublicKeyInit) {
    Data bytes{
        1,   254, 21,  124, 200, 1,   23,  39,  147, 108, 89, 47,  133, 108, 144, 113, 211,
        156, 244, 172, 218, 223, 166, 215, 100, 53,  228, 97, 156, 157, 197, 111, 99,
    };
