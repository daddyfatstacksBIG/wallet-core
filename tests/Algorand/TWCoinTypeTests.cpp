...
TEST(TWAlgorandCoinType, TWCoinType) {
    ...
    auto accId =
        TWStringCreateWithUTF8Bytes("J4AEINCSSLDA7LNBNWM4ZXFCTLTOZT5LG3F5BLMFPJYGFWVCMU37EZI2AM");
    ...
    assertStringsEqual(
        txUrl, "https://algoexplorer.io/tx/CR7POXFTYDLC7TV3IXHA7AZKWABUJC52BACLHJQNXAKZJGRPQY3A");
    assertStringsEqual(accUrl, "https://algoexplorer.io/address/"
