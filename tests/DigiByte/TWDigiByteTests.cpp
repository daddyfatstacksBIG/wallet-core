...
TEST(DigiByteTransaction, SignTransaction) {
    /*
        ...
        m/44'/20'/0'/0/0 Private key in Base58 encoding -
       L37s29UXmQowW7y5BeDhe8AwM7quvRS2FmkWxSuctw9PbFprhhqA m/44'/20'/0'/0/0 Private key in bytes -
    ...
    */
    ...
    ASSERT_EQ(hex(serialized),
              ...
              "00000000"
              "6a"
              "473044022003e9756b12ecbe5788fdb6eb4b6d7b58f9f9410df32f3047edb0dd0ebffb0d630220499d00"
              "d17e50c48b4bac6c0ce148f13bb3109a8845fa3400a2d6a57dabf2c4010121024e525e582452cece7b86"
              "9532d9e354cfec58b71cbed76f7238c91274a64b2116"
              "ffffffff"
              "02"
              "4023050600000000"
              "19"
...
TEST(DigiByteTransaction, SignP2WPKH) {
    /*
        https://iancoleman.io/bip39/
        Mnemonic - shoot island position soft burden budget tooth cruel issue economy destroy above
        m/84'/20'/0'/0/1 Private key in Base58 encoding -
       L3Fy66STjMEzBoQSHLpQbpnLjGywHcjPwZHJ1vKs51pYD25HH49S m/84'/20'/0'/0/1 Private key in bytes -
    ...
    */
    ...
    ASSERT_EQ(
        hex(serialized),
        "0100000000010180a16412a880d13b0c88929397a50341018da2e78b70b313062b4a496fea59400100000000ff"
        "ffffff0280841e00000000001600145c91bc8d2073529224e8be0764128ac22f0005647e351e00000000001600"
        "144b62694cfdd7bdac59cbed211288ccd5c0dabd02024730440220346eed84d79a2e45f0f291c9af91bc71d621"
        "7cff3488047b35c492a3690cd2ce02204724529e4689060532f9286532c87e3b6efb877008e8e44218c1fced7e"
        "df949a012102ac2e56f40d38530fcbf21f1eba0c3c668aa839cda8f2c615e99df44b6447772600000000");
}
...
TEST(DigiByteTransaction, LockScripts) {
    ...
    auto script = WRAP(TWBitcoinScript,
                       TWBitcoinScriptBuildForAddress(
                           STRING("DBfCffUdSbhqKZhjuvrJ6AgvJofT4E2kp4").get(), TWCoinTypeDigiByte));
    ...
    auto script2 =
        WRAP(TWBitcoinScript,
             TWBitcoinScriptBuildForAddress(
                 STRING("dgb1q3p2nf26ac6qtdrv4czh5nmp2eshfj9wyn9vv3d").get(), TWCoinTypeDigiByte));
    ...
    auto script3 =
        WRAP(TWBitcoinScript,
             TWBitcoinScriptBuildForAddress(STRING("SUngTA1vaC2E62mbnc81Mdos3TcvZHwsVo").get(),
                                            TWCoinTypeDigiByte));
