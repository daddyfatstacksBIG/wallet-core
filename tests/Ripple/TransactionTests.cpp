...
TEST(RippleTransaction, serialize) {
    ...
    ASSERT_EQ(hex(serialized1),
              "120000220000000024000000026140000000017d784068400000000000000a81145ccb151f6e9d603f39"
              "4ae778acf10d3bece874f68314e851bbbe79e328e43d68f43445368133df5fba5a");
    ...
    ASSERT_EQ(hex(serialized2),
              "12000022000000002400000090614000000000030d4068400000000000000f8114aa1bd19d9e87be8069"
              "fdbf6843653c43837c03c6831467fe6ec28e0464dd24fb2d62a492aac697cfad02");
    ...
    ASSERT_EQ(hex(serialized3),
              "120000220000000024000000012ef72d50ca6140000000017d784068400000000000000c8114e851bbbe"
              "79e328e43d68f43445368133df5fba5a831476dac5e814cd4aa74142c3ab45e69a900e637aa2");
...
TEST(RippleTransaction, preImage) {
    ...
    ASSERT_EQ(hex(unsignedTx),
              /* prefix */ "53545800"
                           ...
                           /* pub key */ "7321ed5f5ac8b98974a3ca843326d9b88cebd0560177b973ee0b149f7"
                                         "82cfaa06dc66a"
