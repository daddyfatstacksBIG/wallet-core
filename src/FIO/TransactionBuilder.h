...
class TransactionBuilder {
  public:
    ...
    /// @ownerPublicKey FIO address of the owner. Ex.:
    ...
    /// default expiry
    static std::string
    createRegisterFioAddress(const Address& address, const PrivateKey& privateKey,
                             const std::string& fioName, const std::string& ownerPublicKey,
                             const ChainParams& chainParams, uint64_t fee,
                             const std::string& walletFioName, uint32_t expiryTime);
