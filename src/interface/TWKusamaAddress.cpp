...
bool TWKusamaAddressEqual(struct TWKusamaAddress* _Nonnull lhs,
                          struct TWKusamaAddress* _Nonnull rhs) {
...
struct TWKusamaAddress* _Nonnull TWKusamaAddressCreateWithPublicKey(
