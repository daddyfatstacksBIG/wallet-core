...
bool TWEthereumAddressEqual(struct TWEthereumAddress* _Nonnull lhs,
                            struct TWEthereumAddress* _Nonnull rhs) {
...
struct TWEthereumAddress* _Nonnull TWEthereumAddressCreateWithPublicKey(
