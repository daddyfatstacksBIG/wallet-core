...
bool TWPolkadotAddressEqual(struct TWPolkadotAddress* _Nonnull lhs,
                            struct TWPolkadotAddress* _Nonnull rhs) {
...
struct TWPolkadotAddress* _Nonnull TWPolkadotAddressCreateWithPublicKey(
