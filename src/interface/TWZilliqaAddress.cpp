...
bool TWZilliqaAddressEqual(struct TWZilliqaAddress *_Nonnull lhs,
                           struct TWZilliqaAddress *_Nonnull rhs) {
...
struct TWZilliqaAddress *_Nonnull TWZilliqaAddressCreateWithPublicKey(
