...
/// Generic parameter class for numeric types, like bool, uint32, int64, etc.  All are stored on 256
/// bits.
template <typename T>
...
/// Generic parameter class for Uint8, 16, 24, 32, 40, ... 256.  For smaller sizes use the sepcial
/// name like UInt32. Stored on 256 bits.
...
/// Generic parameter class for Int8, 16, 24, 32, 40, ... 256.  For smaller sizes use the sepcial
/// name like Int32. Stored on 256 bits.
