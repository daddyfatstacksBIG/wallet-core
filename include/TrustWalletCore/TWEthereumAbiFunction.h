...
int TWEthereumAbiFunctionAddParamBytesFix(struct TWEthereumAbiFunction *_Nonnull func_in,
                                          size_t count_in, TWData *_Nonnull val, bool isOutput);
TW_EXPORT_METHOD
...
/// the index of the parameter (0-based). Note that nested ParamArrays are not possible through this
/// API, could be done by using index paths like "1/0"
TW_EXPORT_METHOD
